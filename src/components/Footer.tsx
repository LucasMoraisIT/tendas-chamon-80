      ...
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center text-gray-600">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2"><path d="M6 2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z"></path><path d="M12 17.5v.5"></path></svg>
                  (31) 9 8839-7713
                </li>
                <li className="flex items-center text-gray-600">
                ...
                <li className="flex items-center text-gray-600">
                  ...
                  Rua Helo Meireles, 60 - Padre Teodoro II
                </li>
                <li className="flex items-center text-gray-600 ml-5">
                  Sete Lagoas/MG - CEP: 35701-623
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://wa.me/5531988397713" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 flex items-center justify-center bg-gray-200 hover:bg-green-500 hover:text-white rounded-full transition-colors">
        ...
        <div className="pt-6 border-t border-gray-200">
          <p className="text-gray-500 text-center text-sm">
            © {currentYear} Tendas Chamon Locações para Eventos - CNPJ: 18.477.749/0001-90. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
